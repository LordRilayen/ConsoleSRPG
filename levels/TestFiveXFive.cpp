...
#include "TestFiveXFive.h"

Geography::Map Levels::TestFiveXFive::setUpAMap()
{
	Geography::Map Map;
...
std::vector<Entities::BaseCharacter> Levels::TestFiveXFive::setUpCharacters()
{
	...
	std::vector<Entities::BaseCharacter> CharacterVector;
	CharacterVector.push_back(Roxas);
	CharacterVector.push_back(Vanitas);

	return CharacterVector;
}

void Levels::TestFiveXFive::setUpAndTestAMap()
{
	Geography::Map Map;
	...
	std::cout << MapGenerator.BuildMap(Map) << std::endl;
